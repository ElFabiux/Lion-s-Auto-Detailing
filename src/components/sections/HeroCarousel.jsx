...
const HeroCarousel = () => {
  ...
  const slides = [
    {
      ...
      description:
        "Reserve su turno ahora y experimente la comodidad de un servicio personalizado sin esperas ni contratiempos. Su tiempo es valioso y nosotros lo respetamos, por eso le ofrecemos esta opción conveniente y rápida para que pueda organizar su día con total confianza.",
    ...
    },
    {
      ...
      description:
        "Nuestro servicio de mantenimiento diario está diseñado para mantener tu auto en perfectas condiciones todos los días. Ideal para conductores que utilizan su vehículo frecuentemente y desean conservar su apariencia impecable.",
    ...
    },
    {
      ...
      description:
        "Ofrecemos todos los servicios que tu auto necesita en un mismo lugar, desde lavado exterior e interior hasta tratamientos especializados, garantizando comodidad, calidad y resultados impecables sin que tengas que moverte de aquí.",
  ...
  const handleButtonClick = (action) => {
    if (action === "schedule") {
      ...
      window.open(
        `https://wa.me/50688275168?text=${whatsappMessage}`,
        "_blank"
      );
    }
  };
  ...
  return (
    <section
      id="inicio"
      className="relative h-[85vh] sm:h-[90vh] md:h-[92vh] lg:h-[88vh] xl:h-[85vh] overflow-hidden"
    >
      {/* Slides */}
